...
public struct S2C_MOVE : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_2_0_0(); }
  public static S2C_MOVE GetRootAsS2C_MOVE(ByteBuffer _bb) { return GetRootAsS2C_MOVE(_bb, new S2C_MOVE()); }
  public static S2C_MOVE GetRootAsS2C_MOVE(ByteBuffer _bb, S2C_MOVE obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public S2C_MOVE __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
